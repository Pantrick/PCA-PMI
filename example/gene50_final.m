...
TH=[0.500,0.10,0.1500, 0.275,0.400];%fine tuned threshold for roc_50gene null-mutants
ColorMap=hsv(9);
...
%     Gval4=graphicalLasso(corr(NullMU.data),0.2,10^3);Gval4=abs(Gval4);
   ...
   %%
    ...
    legend('boxoff');
    cd(RESULT);
    saveas(gcf,sprintf('%s_gene50.png',File{i}),'png');
    saveas(gcf,sprintf('%s_gene50.eps',File{i}),'psc2');
